...
var connectionString = builder.Configuration.GetConnectionString("DefaultConnection") 
    ?? "Server=localhost;Database=SmartCityHouseControl;User=root;Password=smartcity123;";

builder.Services.AddDbContext<HouseControlDbContext>(options =>
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    { 
        Title = "Smart City House Control Service API", 
        Version = "v1",
        Description = "House automation and device control service for Smart City platform"
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Smart City House Control Service API v1");
...
{
    var context = scope.ServiceProvider.GetRequiredService<HouseControlDbContext>();
