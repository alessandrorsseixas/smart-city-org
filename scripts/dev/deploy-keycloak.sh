...
# Script para deploy do Keycloak no cluster Kubernetes usando overlays de desenvolvimento
# Author: Smart City Automation Project
# Date: $(date)

# Este script aplica os overlays de desenvolvimento do Keycloak:
...
main() {
  ...
  # Aplica os overlays de desenvolvimento do Keycloak
  apply "../../k8s/overlays/dev/keycloak"

  log_success "Deploy Keycloak com overlays de desenvolvimento aplicado"
