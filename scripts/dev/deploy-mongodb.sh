...
# Script para deploy do MongoDB no cluster Kubernetes usando overlays de desenvolvimento
# Author: Smart City Automation Project
# Date: $(date)

# Este script aplica os overlays de desenvolvimento do MongoDB:
...
main() {
  ...
  # Aplica os overlays de desenvolvimento do MongoDB
  apply "../../k8s/overlays/dev/mongo"

  log_success "Deploy MongoDB com overlays de desenvolvimento aplicado"
