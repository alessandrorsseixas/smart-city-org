...
# Script para deploy do RabbitMQ no cluster Kubernetes usando overlays de desenvolvimento
# Author: Smart City Automation Project
# Date: $(date)

# Este script aplica os overlays de desenvolvimento do RabbitMQ:
...
main() {
  echo "=================================="
  echo "  RabbitMQ Deployment Script"
  echo "=================================="
  ...
  # Aplica os overlays de desenvolvimento do RabbitMQ
  apply "../../k8s/overlays/dev/rabbitmq"

  log_success "Deploy RabbitMQ com overlays de desenvolvimento aplicado"
