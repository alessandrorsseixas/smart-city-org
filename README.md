...
├── apps/                                 # Microsserviços e frontend
│   ├── house-control/                    # Spring Boot
│   │   └── src/ + Dockerfile + pom.xml
│   ├── car-control/                      # Quarkus
│   │   └── src/ + Dockerfile + build.gradle
│   ├── energy-control/                   # Quarkus
│   │   └── src/ + Dockerfile
│   ├── audit-service/                    # Spring Boot
│   │   └── src/ + Dockerfile + pom.xml
│   └── frontend-angular/                 # Angular WebApp
│       ├── src/
│       ├── angular.json
│       ├── package.json
│       └── Dockerfile
│
├── shared/                               # CrossCutting / Helpers / Middleware
│   ├── java-common/                      # DTOs, utils, middlewares
│   ├── quarkus-common/                   # Helpers específicos Quarkus
│   └── ts-common/                        # Angular shared code (services, models, utils)
│
...
│   │   └── infra/                        # Prometheus, Grafana, RabbitMQ, Redis, n8n
│   │
...
│       │   └── keycloak.yaml
│       └── projects/
│           ├── core.yaml                 # Keycloak + Auditoria + Notification
│           ├── iot.yaml                  # Casas, Carro, Energia
│           ├── ui.yaml                   # Frontend Angular
...
│   ├── automation/                       # n8n, Argo Workflows
│   └── gitops/                           # Setup inicial ArgoCD
│
├── ci-cd/                                
│   ├── github-actions/                   
│   └── azure-devops/                     
